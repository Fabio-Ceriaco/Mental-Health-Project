...
export const routes: Routes = [
  ...
  {
    path: 'active-cases',
    loadComponent: () => import('./pages/psychologist/active-cases/active-cases'),
    canActivate: [authGuard],
  },
  {
    path: 'employees',
    loadComponent: () => import('./pages/rh/employees/employees'),
    canActivate: [authGuard],
  },
  {
    path: 'patient',
    loadComponent: () => import('./pages/psychologist/patient/patient'),
  },
  {
    path: '**',
    redirectTo: '',
